...
test = test_data.flow_from_directory('testAll',target_size=(i,i), batch_size=64,class_mode='categorical')

NAME = "Bangla_All_Final-{}-conv-{}-dense-{}".format(conv_layers[0],dense_layers[0],int(time.time()))
print(NAME)
model = Sequential()
...
#f = open("AllFinalConf.csv",'w',newline ='')
#a = []
...
#
#
#ff = open("AllFinalReport.txt",'w',newline ='')
#ff.write(f1)
#ff.close()