...
class DataSetGenerator:
    ...
    def get_mini_batches(self, batch_size=10, image_size=(32, 32), allchannel=True):
        images = []
        labels = []
        empty=False
        counter=0
        ...
        while True:
            for i in range(len(self.data_labels)):
                ...
                if not allchannel:
                    ...
                    img = cv2.adaptiveThreshold(img1,255,cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY,11,2)
